        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('profs.index')" :active="request()->routeIs('profs.index')">
                        Profs
                     </x-nav-link>
                     <x-nav-link :href="route('etudients.index')" :active="request()->routeIs('etudients.index')">
                        Etudients
                     </x-nav-link>
                     ...
                     <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown>
                            ...
                            <x-slot name="content">
                                ...
                                <x-nav-link :href="route('branches.create')" :active="request()->routeIs('branches.create')">
                                    Créer
                                 </x-nav-link>
