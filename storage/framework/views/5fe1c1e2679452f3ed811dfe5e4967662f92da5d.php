                                    ...
                                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                                        <form method="POST" action='/matieres'>
                                          ...
                                          <div class="form-group mb-6">
                                            <label for="exampleInputEmail1" class="form-label inline-block mb-2 text-gray-700">Matieres</label>
                                            <input type="text" name="nom" class="form-control
                                              ...
                                              aria-describedby="emailHelp" placeholder="Entrez la matiere">
...
<?php endif; ?><?php /**PATH C:\wamp64\www\m-project\resources\views/matieres/create.blade.php ENDPATH**/ ?>